...
public static class LayerUtil {
	...
	public const int DynamicMask = 1 << 8;
	public const int DamagableMask = 1 << 9;
	public const int ObstacleMask = 1 << 10;
	public const int ProjectileMask = 1 << 11;
	public const int NoneMask = 1 << 31;
	...
	public const int DynamicNumber = 8;
	public const int DamagableNumber = 9;
	public const int ObstacleNumber = 10;
	public const int ProjectileNumber = 11;
	public const int NoneNumber = 31;
}
