...
public class TagsLayersEnumBuilder : EditorWindow
{
    ...
    {
        string tagClassRelativePath = "/Scripts/Utility/" + TAG_CLASS_NAME + CLASS_FILE_ENDING;
        ...
        string layerClassRelativePath = "/Scripts/Utility/" + LAYER_CLASS_NAME + CLASS_FILE_ENDING; 
