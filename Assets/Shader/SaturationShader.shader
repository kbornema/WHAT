Shader "ScreenEffect/Saturation"
{
	Properties
	{
		_MainTex ("Texture", 2D) = "white" {}
		_Factor("Factor", Range(-2.0, 2.0)) = 1.0
	}
	SubShader
	{
		// No culling or depth
		...
		Pass
		{
			...
			{		
				...
				float gray = grayout(worldColor.rgb);

				return (1.0 - _Factor) * float4(gray, gray, gray, worldColor.a) + _Factor * worldColor;
			}
